          ...
          <div className="lg:col-span-7">
            <BrightLayer variant="glass" padding="lg" className="h-full">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Link href="/practicals/business/operations" className="block">
                ...
                <Link href="/practicals/business/credit" className="block">
                  <BrightLayer variant="elevated" padding="md" className="h-full border border-[var(--border-subtle)] hover:border-[var(--brand-primary)] transition-colors">
                ...
                <Link href="/practicals/business/reports" className="block">
                  <BrightLayer variant="elevated" padding="md" className="h-full border border-[var(--border-subtle)] hover:border-[var(--brand-primary)] transition-colors">
                ...
                <Link href="/practicals/business/team" className="block">
                  <BrightLayer variant="elevated" padding="md" className="h-full border border-[var(--border-subtle)] hover:border-[var(--brand-primary)] transition-colors">
                ...
                <Link href="/practicals/business/supply" className="block sm:col-span-2">
                  <BrightLayer variant="elevated" padding="md" className="h-full border border-[var(--border-subtle)] hover:border-[var(--brand-primary)] transition-colors">
